...
HD_PWD='E:/Fotos lab digitales/Guia 2/Parte 1/Parte 1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BCD_to_sevenSeg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BCD_to_sevenSeg.tcl
