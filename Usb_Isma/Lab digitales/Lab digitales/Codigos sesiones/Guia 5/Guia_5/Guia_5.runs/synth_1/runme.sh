...
HD_PWD='E:/Fotos lab digitales/Guia 5/Guia_5/Guia_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_reg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alu_reg.tcl
