...
HD_PWD='E:/Fotos lab digitales/Guia 5/Guia_5/Guia_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_reg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source alu_reg.tcl -notrace
