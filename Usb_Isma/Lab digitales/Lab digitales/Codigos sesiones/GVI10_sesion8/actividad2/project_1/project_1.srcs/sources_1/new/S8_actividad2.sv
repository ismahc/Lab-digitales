...
module S8_actividad2 #(
 ...
 logic [7:0] AN;
 logic [31:0] Todisplay_ext;
 logic [31:0] Tosegments; 
 ...
 S6_Actividad1  Sistema_ALU (.clk(clk), 
  ...
  unsigned_to_bcd Double_Dabble (.clk(clk),
                                 .reset(resetN),
                                 .trigger(1'b1),
                                 .in(Todisplay_ext),
                                 .idle(),
  ...
  Mux MUX_selector (.ToDisplay(ToDisplay),
