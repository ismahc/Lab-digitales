...
HD_PWD='E:/Fotos lab digitales/GVI10_sesion8/actividad2/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log S8_actividad2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source S8_actividad2.tcl
