...
HD_PWD='E:/Fotos lab digitales/GVI10_Sesion4_2023/Act3/Act3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log S4_actividad3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source S4_actividad3.tcl
