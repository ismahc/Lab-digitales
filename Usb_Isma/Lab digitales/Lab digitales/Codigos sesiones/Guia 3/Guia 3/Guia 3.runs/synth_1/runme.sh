...
HD_PWD='E:/Fotos lab digitales/Guia 3/Guia 3/Guia 3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clock_divider_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clock_divider_2.tcl
