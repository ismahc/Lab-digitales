...
HD_PWD='E:/Fotos lab digitales/Guia 3/Guia 3/Guia 3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clock_divider_2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clock_divider_2.tcl -notrace
