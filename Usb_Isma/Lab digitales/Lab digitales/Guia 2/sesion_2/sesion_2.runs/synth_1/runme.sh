...
HD_PWD='C:/Users/ismae/OneDrive/Escritorio/Lab digitales/Guia 1/video_2/video_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fib_rec.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fib_rec.tcl
