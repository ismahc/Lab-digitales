...
HD_PWD='C:/Users/ismae/OneDrive/Escritorio/Lab digitales/Guia 1/video_2/video_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fib_rec.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fib_rec.tcl -notrace
