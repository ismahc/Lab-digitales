...
HD_PWD='C:/Users/ismae/OneDrive/Escritorio/Lab digitales/Guia 4/Act3/Act3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log S4_actividad3_optimizada.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source S4_actividad3_optimizada.tcl -notrace
