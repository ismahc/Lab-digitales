...
HD_PWD='C:/Users/ismae/OneDrive/Escritorio/Lab digitales/Guia 4/Act3/Act3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log S4_actividad3_optimizada.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source S4_actividad3_optimizada.tcl
